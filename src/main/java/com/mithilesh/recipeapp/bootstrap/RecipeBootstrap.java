package com.mithilesh.recipeapp.bootstrap;

import com.mithilesh.recipeapp.enums.Difficulties;
import com.mithilesh.recipeapp.models.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> tableSpoonUomOption = unitOfMeasureRepository.findByUnit("Tablespoon");
        ...
        tacosRecipe.setDifficulties(Difficulties.MODERATE);
